...
var tasks = {
    backend: {src: "assets/scss/backend/main.scss", mode: 'compressed', destination: 'backend.css'},
    frontend: {src: "assets/scss/frontend/main.scss", mode: 'compressed', destination: 'frontend.css'},
};
...
function exportZip(cb) {
	const buildName = `license-pro-v${package.version}.zip`;
